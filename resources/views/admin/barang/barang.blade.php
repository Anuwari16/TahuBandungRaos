        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                <thead class=" thead-dark">
                    <tr>
                        <th>
                            <marquee behavior='slide'>Kode Barang</marquee>
                        </th>
                        <th>
                            <marquee behavior='slide'>Nama Barang</marquee>
                        </th>
                        <th>
                            <marquee behavior='slide'>Stok Barang</marquee>
                        </th>
                        <th>
                            <marquee behavior='slide'>Harga Barang</marquee>
                        </th>
                        <th>
                            <marquee behavior='slide'>Aksi</marquee>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"><a href="{{route('barang.edit',[$brg->kd_brg])}}" class="dnone d-sm-inline-block btn btn-sm btn-success shadow-sm">
