...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('asset/img/tahu_logo.png')}}">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class=" sidebar-brand-icon rotate-n-0">
                    <img src="{{asset('asset/img/tahu_logo.png')}}" width="150">
                </div>
            </a>
            <br></br>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('agen.index') }}">Master Agen</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('preorder.transaksi') }}"> Pre Order</a>
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('penjualan.transaksi') }}"> Transaksi Penjualan</a>
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('datapenjualan.transaksi') }}"> Data Penjualan</a>
                    </div>
                </div>
            </li>
            @endrole
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('laporanpenjualan.index') }}"> Laporan Penjualan</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Create By: Kelompok 5 <br>Copyright &copy; APSIA 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
